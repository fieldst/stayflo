...
export default function AdminBar() {
  ...
  // ✅ SafeFlow "home" = guest portal home for the active property
  ...
  // ✅ HARD logout:
  // 1) clear cookie via POST
  // 2) force full page load to guest portal home (SafeFlow home)
  // This guarantees AdminBar disappears immediately.
  const onLogout = useCallback(async () => {
    ...
    window.location.replace(guestHubHref);
  }, [guestHubHref]);
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="shrink-0">
            ...
            <div className="hidden sm:flex items-center gap-1.5">
              ...
              <button type="button" onClick={onLogout} className={pillClass} title="Logout">
                Logout
              </button>
            </div>
          </div>
