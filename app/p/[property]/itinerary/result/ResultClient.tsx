...
export default function ResultClient() {
  ...
  const planDay: "today" | "tomorrow" = planDayParam === "tomorrow" ? "tomorrow" : "today";
    ...
    setItinerary((prev) => {
      ...
      return {
        ...
        blocks: prev.blocks.map((b) =>
          b.id === args.blockId
            ? { ...b, whyThis: json.whyThis, tips: json.tips }
            : b
        ),
      };
    });
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 text-sm text-white/70">
          Generating your itinerary… (pulling top-rated spots from Google)
        </div>
      ) : error ? (
        ...
        <>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-1 text-sm text-white/70">If you want to make the stay easier, request these below.</p>
